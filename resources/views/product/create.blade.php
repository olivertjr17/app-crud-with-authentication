<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-md mx-auto mt-5 p-6 bg-white rounded-lg shadow-xl">
                @if ($errors->any())
                ...
                <form action="{{ route('product.store') }}" method="post" class="space-y-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="price" id="price" step="any" placeholder="Enter Price"
                            class="mt-1 p-2 border rounded-md">
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <textarea name="description" id="description" cols="30" rows="5" placeholder="Enter Description"
                            class="mt-1 p-2 border rounded-md"></textarea>
                    </div>

                    <div class="flex justify-end">
                        <input type="reset" value="Reset" class="px-4 py-2 bg-gray-300 rounded-md mr-2">
                        <input type="submit" value="Create" class="px-4 py-2 bg-blue-600 text-white rounded-md">
                    </div>
                </form>
            </div>
        </div>
